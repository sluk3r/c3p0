    ...
    private void writeObject(ObjectOutputStream oos) throws IOException {
        ...
        try {
            ...
            try {
                ...
                oos.writeObject(indirectionOtherException.indirectForm(this.nestedDataSource));
            } catch (IOException var4) {
                throw var4;
            } catch (Exception var5) {
                throw new IOException("Problem indirectly serializing nestedDataSource: " + var5.toString());
            }
        }
